...
#3445 grids total
train = pd.read_csv('C:\\\\Users\\Lucian Murdock\\Desktop\\Computational_Intelligence\\Crime_Prediction\\Data\\Crime_Data\\Results\\initial2017Test.csv')
#print(train.head())
...
with open("./CrimeWebsite/testGEO.json", 'w') as json_file:
