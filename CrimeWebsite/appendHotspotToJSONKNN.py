...
train = pd.read_csv('C:\\Users\\willi\\Documents\\Data\\KNNinitial2017Test.csv')
...
with open("C:\\xampp\\htdocs\\HotspotPredictions\\CrimeWebsite\\KNNGEO.json", 'w') as json_file:
