...
#3445 grids total
train = pd.read_csv('C:\\Users\\willi\\Documents\\Data\\Mutilayer2017Test.csv')
#print(train.head())
...
with open("C:\\xampp\\htdocs\\HotspotPredictions\\CrimeWebsite\\MLPGEO.json", 'w') as json_file:
